...
class Dataset(base.ImageDataset):
    ...
    def get_train_set(use_augmentation):
        ...
        return Dataset(os.path.join(get_platform().tinyimagenet_root, 'train'), transforms)

    @staticmethod
    def get_test_set():
        return Dataset(os.path.join(get_platform().tinyimagenet_root, 'val'), Dataset._transforms())
