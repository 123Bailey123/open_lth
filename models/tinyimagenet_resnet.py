...
class ResNet(torchvision.models.ResNet):
    def __init__(self, block, layers, num_classes=200, width=64):
...
class Model(base.Model):
    ...
    def __init__(self, model_fn, initializer, outputs=None):
        ...
        self.model = model_fn(num_classes=outputs or 200)
    ...
    @staticmethod
    def default_hparams():
        """These hyperparameters will reach XX.X% top-1 accuracy on TinyImageNet.
        ...
        model_hparams = hparams.ModelHparams(
            model_name='tinyimagenet_resnet_50',
